...
public abstract class ElysiumBlockFluid extends Block
{
    @SideOnly(Side.CLIENT)
    protected Icon[] theIcon;

    protected ElysiumBlockFluid(int par1, Material par2Material)
    {
    ...
    public static double getFlowDirection(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, Material par4Material)
    {
        ...
        {
            vec3 = ((ElysiumBlockFluid) Elysium.waterMoving).getFlowVector(par0IBlockAccess, par1, par2, par3);
        }

				...
				for (int i1 = -2; i1 <= 2; ++i1) {
					for (int j1 = -1; j1 < 3; ++j1) {
						...
						this.worldServerInstance.setBlock(k1, l1, i2,
								flag ? Block.blockDiamond.blockID : 0);
					}
				}
			}
			...
			for (k1 = l - short1; k1 <= l + short1; ++k1) {
				...
				for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1) {
					...
					for (int i2 = this.worldServerInstance.getActualHeight() - 1; i2 >= 0; --i2) {
						/** change this block **/
						if (this.worldServerInstance.getBlockId(k1, i2, l1) == Elysium.TutorialPortal.blockID) {
							/** change this block **/
							while (this.worldServerInstance.getBlockId(k1,
									i2 - 1, l1) == Elysium.TutorialPortal.blockID) {
								--i2;
							}
		...
		if (d3 >= 0.0D) {
			if (flag) {
				this.destinationCoordinateCache.add(j1,
						new TutorialPortalPosition(this, i, j, k,
			...
			int j2 = -1;
			/** change this block **/
			if (this.worldServerInstance.getBlockId(i - 1, j, k) == Elysium.TutorialPortal.blockID) {
				j2 = 2;
			}
			/** change this block **/
			if (this.worldServerInstance.getBlockId(i + 1, j, k) == Elysium.TutorialPortal.blockID) {
			...
			/** change this block **/
			if (this.worldServerInstance.getBlockId(i, j, k - 1) == Elysium.TutorialPortal.blockID) {
				j2 = 3;
			}
			/** change this block **/
			if (this.worldServerInstance.getBlockId(i, j, k + 1) == Elysium.TutorialPortal.blockID) {
		...
		for (k2 = 0; k2 < 4; ++k2) {
			for (i3 = 0; i3 < 4; ++i3) {
				for (l2 = -1; l2 < 4; ++l2) {
					...
					/** change these blocks **/
					this.worldServerInstance.setBlock(k3, j3, i4,
							flag ? Block.blockDiamond.blockID

...
import mods.elysium.block.ElysiumBlock;
...
public class ChunkProviderElysium implements IChunkProvider {
	...
	public void replaceBlocksForBiome(int chunkX, int chunkZ,
		...
		this.stoneNoise = this.noiseGen4.generateNoiseOctaves(this.stoneNoise,
				chunkX * 16, chunkZ * 16, 0, 16, 16, 1, var6 * 2.0D, var6 * 2.0D,
				var6 * 2.0D);
			...
			for (int var9 = 0; var9 < 16; var9++) {
				...
				for (int k = 127; k >= 0; k--) {
					...
					if (k <= 0 + this.rand.nextInt(5)) {
						 ...
						 **/
						else if (var18 != Elysium.paleStone.blockID) {
							if (var13 == -1) {
								if (var12 == 0) {
									var14 = 0;
								...
								if ((k < seeLevel) && (var14 == 0)) {
									if (var11 < 0.15F) {
										...
										var14 = (byte) Elysium.waterStill.blockID;
									}
								}
								var13 = var12;
								if (k >= seeLevel - 1) {
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
		...
		if ((!var11) && (this.rand.nextInt(4) == 0)) {
			...
			new WorldGenLakes(Elysium.waterStill.blockID).generate(this.worldObj,
...
////                                if ((d16 += d15) > 0.0D)
////                                {
//////                                  par3ArrayOfByte[j2 += short1] = (byte)Block.stone.blockID;203
////                                  par3ArrayOfByte[j2 += short1] = (byte)Elysium.paleStone.blockID;
////                                }
////                                else if (k1 * 8 + l1 < b2)
////                                {
...
//                                    else
//                                    {
//                                        b1 = (byte)Elysium.waterStill.blockID;
//                                    }
//                                }
//
//                                j1 = i1;
...
//            (new WorldGenLakes(Elysium.waterStill.blockID)).generate(this.worldObj, this.rand, k1, l1, i2);
//        }
//

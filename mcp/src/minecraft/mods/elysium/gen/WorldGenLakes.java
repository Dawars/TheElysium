        ...
        else
        {
            ...
            for (i1 = 0; i1 < 16; ++i1)
            {
                for (j2 = 0; j2 < 16; ++j2)
                {
                    for (i2 = 4; i2 < 8; ++i2)
                    {
                        if (aboolean[(i1 * 16 + j2) * 8 + i2] && par1World.getBlockId(par3 + i1, par4 + i2 - 1, par5 + j2) == Elysium.soilBlock.blockID && par1World.getSavedLightValue(EnumSkyBlock.Sky, par3 + i1, par4 + i2, par5 + j2) > 0)
                        {
...
//                            else
//                            {
                                par1World.setBlock(par3 + i1, par4 + i2 - 1, par5 + j2, Elysium.grassBlock.blockID, 0, 2);
//                            }
                        }
                    }
                }
                ...
                for (i1 = 0; i1 < 16; ++i1)
                {
                    for (j2 = 0; j2 < 16; ++j2)
                    {
                        for (i2 = 0; i2 < 8; ++i2)
                        {
                            ...
                            {
                                par1World.setBlock(par3 + i1, par4 + i2, par5 + j2, Elysium.paleStone.blockID, 0, 2);
                            }
                        }
                    }
                }

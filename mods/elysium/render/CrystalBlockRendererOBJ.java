...
//		GL11.glRotatef(90F, 1F, 0F, 0F);
		...
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(TEXTURE_CRYSTAL);
		renderer.renderBlockAllFaces(Elysium.blockPalestone, x, y, z);
		//this.model.renderAll();
		
//		GL11.glEnable(GL11.GL_LIGHTING);
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(TEXTURE_TERRAIN);

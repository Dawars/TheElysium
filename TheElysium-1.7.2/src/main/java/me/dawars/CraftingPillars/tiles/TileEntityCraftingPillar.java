...
//				{
//					ItemStack result = CraftingPillarsAPIHelper.findMatchingArcaneRecipe(this.container.craftMatrix, this.closestPlayer);
//					if(result != null)
//					{
//						FMLLog.warning("Result " + result.getDisplayName());
//
//						this.inventory[this.getSizeInventory()] = result;
//						aspectsForRecipe = CraftingPillarsAPIHelper.findMatchingArcaneRecipeAspects(this.container.craftMatrix, this.closestPlayer);
//						
...
//
//					AspectList aspects = CraftingPillarsAPIHelper.findMatchingArcaneRecipeAspects(this.container.craftMatrix, player);
//					if(aspects != null)
//					{
...
//			}
	...
	public boolean isItemValidForSlot(int slot, ItemStack itemstack)
	{
		if(!CraftingPillars.modThaumcraft)
			return false;
		return slot == 10 && itemstack.getItem() == CraftingPillars.itemWandThaumcraft;
	}

...
public class RenderTankPillar extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler
{
	...
	public RenderTankPillar()
	{
		...
		this.TEXTURE_TANKPILLAR = new ResourceLocation(CraftingPillars.ID + ":textures/models/freezerPillarFrozen.png");
		 else
		 this.TEXTURE_TANKPILLAR = new ResourceLocation(CraftingPillars.ID + ":textures/models/freezerPillar.png");

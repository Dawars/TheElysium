...
public class RenderDiskPillar extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler
{
	...
	public RenderDiskPillar()
	{
		...
		this.Nail = new ModelRenderer(model, 0, 0);
		this.Nail.addBox(-0.5F, 0F, -0.5F, 1, 2, 1);
		this.Nail.setRotationPoint(0F, 6F, 0F);
		this.Nail.setTextureSize(128, 64);
	...
	public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer)
	{
		...
		glRotatef(180F, 1F, 0F, 0F);
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(this.TEXTURE_DISKPILLAR);
		this.render(0.0625F);
		glPopAttrib();
		glPopMatrix();
	}

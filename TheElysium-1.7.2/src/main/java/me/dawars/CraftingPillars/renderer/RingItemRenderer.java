...
public class RingItemRenderer implements IItemRenderer
{
    ...
    {			
    	...
    	if(type == ItemRenderType.INVENTORY)
		{
			...
			itemRenderer.renderItemAndEffectIntoGUI(FMLClientHandler.instance().getClient().fontRenderer, FMLClientHandler.instance().getClient().getTextureManager(), new ItemStack(CraftingPillars.itemRingDummy), 0, 0);

...
public class ElysiumBlockQuartz extends BlockQuartz
{
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_)
    {
        ...
        for (int i = 0; i < this.field_150192_M.length; ++i)
        {
            ...
            {
                this.field_150192_M[i] = p_149651_1_.registerIcon(this.getTextureName() + "_" + field_150189_b[i] + "_mossy2");
            }
        }

        this.field_150190_P = p_149651_1_.registerIcon(this.getTextureName() + "_top_mossy2");
        this.field_150193_N = p_149651_1_.registerIcon(this.getTextureName() + "_chiseled_top_mossy2");
        this.field_150194_O = p_149651_1_.registerIcon(this.getTextureName() + "_lines_top_mossy2");
        this.field_150188_Q = p_149651_1_.registerIcon(this.getTextureName() + "_bottom_mossy2");
    }

...
//			player.worldObj.setLightValue(EnumSkyBlock.Sky, (int) player.posX, (int) player.posY + 1, (int) player.posZ, 16);
//			player.worldObj.updateLightByType(EnumSkyBlock.Sky, (int) player.posX, (int) player.posY + 1, (int) player.posZ);
//
//		}
	}

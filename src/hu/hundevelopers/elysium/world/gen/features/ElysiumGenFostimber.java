...
public class ElysiumGenFostimber extends WorldGenerator
{
	...
	public ElysiumGenFostimber(Block leaves, Block log, boolean fromSapling)
	{
		super(fromSapling);
		this.leaves = leaves;
		this.log = log;
	...
	public ElysiumGenFostimber(Block leaves, Block log, int leavesMeta, int logMeta, boolean fromSapling)
	{
